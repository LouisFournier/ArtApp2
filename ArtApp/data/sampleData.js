...
RealtorApp.data.SampleData = [
    ...
    },
    {
        ...
        Features: "Look Mickey, également connu comme Look Mickey!, est une huile sur toile de 1961 de l'artiste américain Roy Lichtenstein. Il est considéré comme un pont entre ses œuvres d'expressionnisme abstrait et de pop art. Il est remarquable comme étant le premier exemple de l'emploi par l'artiste de points Benday (trames), de phylactères (bulles pour les dialogues) et d'images humoristiques comme source pour une peinture. Le tableau a été offert à la National Gallery of Art de Washington par l'artiste et sa femme pour l'anniversaire des 50 ans du musée1. Le tableau est une reprise d'une illustration de Donald Duck Lost and Found de Bob Grant et Bob Totten montrant Donald Duck et Mickey Mouse lors d'une partie de pêche. Le tableau a été partiellement reproduit dans un autre tableau de Lichtenstein réalisé en 1973, Artist's Studio—Look Mickey.",
        Images: ["data/Homes/leradeaudelameduse.jpg"]
    },
    {
        ID: "3",
    ...
    {
        ID: "23",
        Address: "nom de l'oeuvre",
        City: "1992",
        State: "nom de l'artiste",
        ZipCode: "98131",
        Name: "le radeau de la méduse",
        Year: "1818-1819",
        Artiste: "Théodore Géricault",
        ...
        Type: "0",
        Status: "1",
        Images: ["data/Homes/leradeaudelameduse.jpg.jpg", "data/Homes/23b.jpg"],
        Agent: {
            Name: "Robert Powell",
            Phone: "(555) 630-8133",
